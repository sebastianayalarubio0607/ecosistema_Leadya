        ...
        @foreach ($navItems as $item)
            ...
            <a href="{{ route($item['route']) }}" wire:navigate
                ...
                <span
                    ...
                    @elseif ($item['icon'] === 'meta-logo')
                        <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6" viewBox="0 0 24 24" fill="none"
                            stroke="currentColor" stroke-width="1.8" aria-hidden="true">
                            <path stroke-linecap="round" stroke-linejoin="round"
                                d="M3 14.1C3 10.35 5.03 7 7.6 7c1.88 0 3.1 1.5 4.4 3.72C13.3 8.5 14.52 7 16.4 7 18.97 7 21 10.35 21 14.1c0 2.05-.9 3.4-2.28 3.4-1.45 0-2.55-1.45-3.96-3.95L12 8.86l-2.76 4.69C7.83 16.05 6.73 17.5 5.28 17.5 3.9 17.5 3 16.15 3 14.1Z" />
                        </svg>
                    @elseif ($item['icon'] === 'google-ads-logo')
                        <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6" viewBox="0 0 24 24" aria-hidden="true">
                            <path fill="#4285F4"
                                d="M10.6 4.2a2.4 2.4 0 0 1 4.1.9l5.2 12.1a2.4 2.4 0 0 1-4.4 1.9L10.3 7a2.4 2.4 0 0 1 .3-2.8z" />
                            <path fill="#34A853"
                                d="M9.8 5.1a2.4 2.4 0 0 1 4.2 2.4L8.5 17.9a2.4 2.4 0 1 1-4.2-2.3L9.8 5.1z" />
                    ...
                    @elseif ($item['icon'] === 'insights')
                        <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" viewBox="0 0 20 20" fill="currentColor">
                            <path d="M4 3a1 1 0 00-1 1v12a1 1 0 001 1h12a1 1 0 100-2H5V4a1 1 0 00-1-1z" />
                            <path
                    ...
                    @elseif ($item['icon'] === 'ads')
                        <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" viewBox="0 0 20 20" fill="currentColor">
                            ...
                            <path
                                d="M6.5 15H8l.7 2.1A1 1 0 017.75 18H6.8a1 1 0 01-.95-.68L5 14.75c.47.16.97.25 1.5.25z" />
                        </svg>
                    ...
                    @elseif ($item['icon'] === 'gads-campaigns')
                        <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" viewBox="0 0 20 20"
                            ...
                            <path fill-rule="evenodd" d="M3 17a1 1 0 001 1h13a1 1 0 100-2H4a1 1 0 00-1 1z"
                                clip-rule="evenodd" />
                        </svg>
    ...
    <div class="border-t border-white/10 p-2">
        <div class="flex flex-col gap-2">
            ...
            <a href="{{ route('profile') }}" wire:navigate
                class="w-full flex items-center gap-3 rounded-xl px-3 py-2 hover:bg-white/5 transition"
                title="Perfil">
