...
class KommoIntegrationService
{
    public function sendToKommo(Lead $lead, Integration $integration)
    {
        ...
        // 2) Normaliza URL: Kommo "complex leads" suele ser /api/v4/leads/complex
        ...
        Log::info('KOMMO URL', ['url' => $url]);
        Log::info('KOMMO PAYLOAD JSON', [
        ...
        if ($response->successful()) {
            ...
            if ($kommoLeadId !== null) {
                ...
                Log::warning('Kommo OK pero sin "id" de lead en respuesta', [
                    'local_lead_id' => $lead->id,
                    'json' => $json,
                ]);
            }
    ...
    /**
     * Crea una estructura de custom field para Kommo,
