...
class LeadService
{
    ...
    public function validateLeadRequest($request)
    {
        $validated = $request->validate([
            ...
            'whasapp_user_id' => 'sometimes|nullable|string|max:255',
            'ctwa_clid'       => 'sometimes|nullable|string|max:255',
            'whatsapp_business_account_id' => 'sometimes|nullable|string|max:255',
            'number_whatsApp_companies' => 'sometimes|nullable|string|max:255',
            'WhatsApp_username' => 'sometimes|nullable|string|max:255',
