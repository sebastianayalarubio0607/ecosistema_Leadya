...
return new class extends Migration
{
    public function up(): void
    {
        Schema::create('google_ads_ads', function (Blueprint $table) {
            ...
            $table->string('google_ad_group_id', 32);
            $table->string('ad_group_name')->nullable();
            $table->string('google_ad_id', 32);
            $table->string('ad_status', 50)->nullable();
            ...
            $table->unique(['customer_id', 'google_ad_id', 'report_date'], 'gads_ad_unique_daily');
            $table->index(['customer_id', 'report_date'], 'gads_ad_customer_report_idx');
        });
    }
