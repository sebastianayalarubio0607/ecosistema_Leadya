...
return new class extends Migration
{
    public function up(): void
    {
        Schema::create('google_ads_ad_groups', function (Blueprint $table) {
            ...
            $table->string('ad_group_status', 50)->nullable();
            ...
            $table->unique(['customer_id', 'google_ad_group_id', 'report_date'], 'gads_ad_group_unique_daily');
            $table->index(['customer_id', 'report_date'], 'gads_ad_group_customer_report_idx');
        });
    }
