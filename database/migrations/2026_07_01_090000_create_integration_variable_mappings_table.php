...
return new class extends Migration
{
    public function up(): void
    {
        ...
        Schema::create('integration_variable_mappings', function (Blueprint $table) {
            ...
            $table->index(['integration_id', 'target_variable', 'lead_field'], 'integration_mapping_variable_field_index');
            $table->index(['integration_id', 'active', 'order'], 'integration_mapping_active_order_index');
        });
    }

    public function down(): void
    {
        Schema::dropIfExists('integration_variable_mappings');
    }
};
